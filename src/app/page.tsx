...
export default function Home() {
  return (
    <>
      ...
      <div className='bg-gray-300 dark:bg-[#1e1b4b] bg-gradient-to-t overflow-hidden w-full relative xs:pt-10'>
        ...
        <div className='relative xs:mx-2 sm:mx-8 md:mx-12 lg:mx-16 xl:mx-24 md:mt-10'>
          <section id="experiencia">
            <div className="absolute left-60 bottom-60 blob w-[450px] h-[450px] rounded blur-3xl bg-opacity-60 bg-gradient-to-r from-indigo-400 to-green-200 dark:from-indigo-600 dark:to-purple-700"></div>
            <Experience/>
          </section>
        </div>
        {/* <Projects/> */}
        <section 
          id='contato' 
          className='xs:h-[850px] sm:h-[750px] p-6 xs:rounded-tl-[10%] sm:rounded-tl-[20%] xs:rounded-tr-[10%] sm:rounded-tr-[20%] md:rounded-tl-[40%] md:rounded-tr-[40%] lg:rounded-tl-[50%] lg:rounded-tr-[50%] bg-indigo-900 overflow-hidden w-full mt-48'
        >
          <Contact/>
        </section>
      </div>
