...
export default function Apresentacao() {
  ...
  return(
    <>
      ...
      <div className="hidden lg:block absolute -bottom-1/12 right-0 left-0 mx-auto w-big h-big bg-indigo-900 rounded-full -z-10"></div>
      <div className="absolute top-1/3 left-5 text-xl sm:left-10 sm:text-4xl md-left-1/4 md:text-6xl lg:left-5 xl:left-48 xl-text-7xl font-bold">
        <span className="font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-gray-700 via-gray-800 to-gray-500">Full-Stack</span>
        <p className="font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-indigo-900 to-indigo-500">Developer</p>
      </div>
