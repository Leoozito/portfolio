            ...
            <div className="w-full flex items-center grid-cols-2 justify-center 2xl:mt-10">
                ...
                <div className="w-1/2 xl-w:1/2 flex flex-col gap-6 justify-between items-start z-10">
                    <div className="flex flex-row items-center mt-10">
                        ...
                        <span className="md:inline-flex md:w-[500px] h-[6px] bg-indigo-800 dark:bg-[#818cf8] ml-6"></span>
                    </div>
                    <motion.div 
                    ...
                    >
                        <Card className="mt-2 dark:bg-[#1e293b]">
                            <p className="dark:text-white text-lg p-2 md:p-6 rounded-md">
                                <span className="font-extrabold text-indigo-700 dark:text-[#818cf8]">Mais sobre minha pessoal</span>,
