...
export default function Apresentacao() {
  ...
  return(
    <>
      ...
      <div className="items-center absolute top-1/3 left-5 sm:left-10 xs:text-2xl xs:left-12 md:text-3xl xl:text-4xl 2xl:text-5xl lg:left-5 xl:left-48 font-bold xs:top-36">
      ...
      <div className="xs:items-center sm:items-center lg:items-start xs:flex sm:flex flex-col lg:gap-5 xs:gap-1 sm:gap-1 absolute rounded-md shadow-lg top-0 xs:-bottom-64 sm:bottom-14 xl:bottom-0 m-auto lg:right-10 xs:right-20 sm:right-4 dark:bg-[#1e293b] bg-white lg:p-6 xs:p-4 sm:p-4 h-fit xs:w-72 xs:h-48 sm:w-72 lg:w-80 xl:w-96 2xl:w-1/3">
        ...
        <a className="dark:bg-gradient-to-r dark:from-[#7dd3fc] bg-indigo-600 text-white xs:text-sm sm:text-sm xl:text-xl sm:px-2 xs:p-1.5 sm:py-1 lg:px-3 lg:py-2 rounded-md font-semibold w-fit xs:mt-2.5 sm:mt-1.5 lg:mt-0" href="#">Contate-Me</a>
