...
export default function Apresentacao() {
  ...
  return(
    <>
      <Image width={760} height={160} className="items-center block absolute mx-auto 2xl:bottom-0 xs:top-8 sm:top-36 md:-bottom-20 right-0 xs:left-6 sm:left-12 lg:block sm:mt-6 h-5/6 object-cover xs:p-16 sm:p-14 2xl:p-0" src='/my-picture.png' alt="Minha foto perfil"/>
      ...
      <div className="xs:items-center sm:items-center lg:items-start xs:flex sm:flex flex-col lg:gap-5 xs:gap-1 sm:gap-1 absolute rounded-md shadow-lg top-0 xs:-bottom-80 sm:bottom-14 xl:bottom-0 m-auto lg:right-10 xs:right-4 sm:right-4 dark:bg-[#1e293b] bg-white lg:p-6 xs:p-3 sm:p-4 h-fit xs:w-56 sm:w-56 lg:w-80 xl:w-96 2xl:w-1/3">
